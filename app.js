const projectData = {
  ...
  'Didi & Friends × Darlie': {
    ...
    deliverables: 'Assets were delivered for YouTube, social platforms, and TVC in formats ranging from 15-second cuts to a three-minute video.',
  ...
  'Didi & Friends × SSPN': {
    ...
    challenge: 'The campaign was tied to a live event, leaving a tight three-month production window. Alongside the full three-minute collaboration video, we needed a 15-second TVC cutdown approved by FINAS.',
  ...
  'Sirah Nabawiyah': {
    ...
    challenge: 'The project needed to evolve through audience feedback while maintaining a clear story formula, consistent visual direction, and an efficient production system for a 2D animation pipeline.',
    led: 'Managed the project from development through final delivery; created and documented the production blueprint and guidelines; defined the project look and feel; and continuously improved the process as new audience feedback emerged.',
...
toggle.addEventListener('click', () => {
  ...
  toggle.textContent = isOpen ? `Browse all projects (${moreNames.length})` : 'Hide project library';
